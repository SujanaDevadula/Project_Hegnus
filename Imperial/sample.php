...
<!--              <form action="forms/contact.php" method="post" role="form" class="php-email-form">-->
               ...
               <form method="post" id="myform" action="" id="myform"  >
            ...
            <table align="center">
               ...
               <div >
                  ...
                  <tr>
                     ...
                     <td><input type="text" size="50" id="email" name="email" placeholder="Your email"
                       required ><br/><br/></td>
                    ...
                    <tr>
                     ...
                     <td><input type="text" size="50" id="subject" name="subject" placeholder="Subject"
                        required><br/><br/></td>
                  ...
                  <tr>
                     ...
                     <td> <textarea rows="5" cols="53" size="50" name="message" id="message" placeholder="Message " required > </textarea><br/><br/></td>
                  </tr>
                  <tr>
