...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/boots trap.min.js"></script>
...
<!--            <p class="section-description">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium</p>-->
        ...
        <div class="row">
          <div class="col-md-4 service-item">
            ...
            <h3 class="service-title"><a href="home-automation.html">Home Automation</a></h3>
          ...
          <div class="col-md-4 service-item">
            ...
            <h3 class="service-title"><a href="security-services.html">Security Services</a></h3>
          ...
          <div class="col-md-4 service-item">
            ...
            <h3 class="service-title"><a href="agriculture-automation.html">Agriculture Automation</a></h3>
          ...
          <div class="col-md-4 service-item">
            ...
            <h3 class="service-title"><a href="office-automation.html">Office Automation</a></h3>
          ...
          <div class="col-md-4 service-item">
            ...
            <h3 class="service-title"><a href="industrial-automation.html">Industrial Automation</a></h3>
          ...
          <div class="col-md-4 service-item">
            ...
            <h3 class="service-title"><a href="customized-automation.html">Customized Automation</a></h3>
            ...
            <div class="col-md-4 service-item">
            <div class="service-icon"><i class="fa fa-shopping-bag"></i></div>
            <h3 class="service-title"><a href="privatesector-automation.html">Private Sector Automation</a></h3>
            <p class="service-description"></p>
          </div>
             <div class="col-md-4 service-item">
            <div class="service-icon"><i class="fa fa-shopping-bag"></i></div>
            <h3 class="service-title"><a href="hotel-automation.html">Hotel/Resorts Automation</a></h3>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-4" style="background-color:whitesmoke;padding:10px;">
          <h1 style="margin-left:  10%;"><b>How it works</b></h1><br/><br/>
      <div style="margin-left:  20%;">
      <h4><b>
          <i style='font-size:24px' class='fas'>&#xf245;</i> &nbsp;&nbsp;</b><b> Step 1: Pick a Home Automation Theme</b><br/><br/><p>Explore the concepts and use-cases to find a theme that's intresting to you</p></h4><br/>
    ...
    <img src="assets/img/testimonial.png"  width=100% style="width:100%;margin-top:100px;">
    </div>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-4" style="background-color:black;padding:50px;">
          <center>
     <p class="glow" >
        <br/>
        <span class="glyphicon">&#xe230;</span>&nbsp;&nbsp;Fast&nbsp;&nbsp;</p>
    ...
    <div class="col-sm-4" style="background-color:black;padding:50px;">
     ...
     <p class="glow" >
        <br/>
        <span class='fas fa-shield-alt' ></span>&nbsp;&nbsp;Secure&nbsp;&nbsp;</p>
        <br/>
    <p style="color:aliceblue;font-size: 15px;text-align: left; ">Security is the principal motive for us,we deliver products with the utmost security.Your protection is our prime concern</p>
        </center>
    </div>
    ...
    <div class="col-sm-4" style="background-color:black;padding:50px;">
     ...
     <p class="glow" >
        <br/>
        <span class='far fa-thumbs-up'> </span>&nbsp;&nbsp;Easy&nbsp;&nbsp;</p>
        <br/>
    <p style="color:aliceblue;font-size: 15px;text-align: left; ">Our streamlined ordering process makes it one of the most straightforward processes which you can ever seek for.</p>
    </center>
    </div>
...
<!--              <form action="forms/contact.php" method="post" role="form" class="php-email-form">-->
         <form action="contact.php" method="post" role="form" onsubmit = "return validate();" >        
<!--                onsubmit="myFunction()"-->
                
                <div class="form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" pattern="[a-zA-Z ]{4,}" title="Only letters allowed" required>
                 
                </div>
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Your Email"  autocomplete="email" pattern="[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[A-Za-z0-9.-]+\.+(com)"        
             ...
             <div>
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" pattern="[a-zA-Z0-9 ]{4,}" 
                                title="Only letters allowed" required>
                  
                </div>
                <div class="form-group">
                  <textarea class="form-control" name="message" rows="5"  placeholder="Message" pattern="[a-zA-Z0-9 ]{4,}"                                  title="Only letters allowed" required></textarea>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          -->
            Designed by <a href="">Devadula Sai Sujana</a>
          </div>
        </div>
      </div>
    </div>
